// Display implementation for ESP32-S3-Box-3
// Based on working examples from M5Stack CoreS3 and Slint mcu-board-support
// Simplified for ESP32-S3-Box-3 hardware (no GPIO expander or power management needed)
